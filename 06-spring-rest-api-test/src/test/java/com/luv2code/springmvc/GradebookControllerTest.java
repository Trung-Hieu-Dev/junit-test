...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("lastname", "Brown");
        request.setParameter("emailAddress", "john_brown@email.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        student.setLastname("Susan");
        student.setEmailAddress("mary_susan@email.com");
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("mary_susan@email.com");
